...
export type UserDropdownProps = Omit<BaseUserDropdownProps, 'user' | 'onManageProfile'> & {
   ...
   * profile/account page it wants to navigate to instead, for example with a router's
   * `navigate()`.
   *
   * @example
   * ```tsx
   * <UserDropdown manageProfileLabel="Manage Account" onManageProfile={() => navigate('/account')} />
   * ```
   */
...
const UserDropdown: FC<UserDropdownProps> = ({
  ...
  const {user, isLoading, signOut, meta} = useThunderID();
