...
describe('mapCredentialUpdateError', (): void => {
  ...
  it('should report a 403 at form level, since this form collects no current-value field', (): void => {
    const result = mapCredentialUpdateError(apiError(403, 'Not allowed'));
